// Exemplo de switch-case variável 
let nome
...
switch(nome){
    ...
    case 'Abgail':
        ...
        alert("Que nome maravilhoooooooso!")
        break

    case 'Ermenegildo':

        alert("Número digitado foi um! :D")
        break

    case 2:

        alert("Número digitado foi dois! :D")
        break

    default:

        alert("Número digitado não foi 0, 1, 2...")

}


// Exemplo de switch-case booleano 
